...
v1: dense=32, epoch=50, lr=0.0001, batchsize=16, units=128
"""
...
model.add(GRU(units=128))    # I can have couple LSTMs, but the last one shoule be the return_sequences=Flase in this case
#model.add(Dropout(0.5))
...
model.save('./Q1cnngrumodel.modis.v1.h5')
#######################################################################################################################
#######################################################################################################################
# perpare feature data (SITE C) with the order: 2015, 2016, 2017, 2018, 2019, 2020
...
meta['height'] = 211
meta['nodata'] = 5
out_file = './result/MCD43A4202009SE.CNNGRU.v1.tif'
